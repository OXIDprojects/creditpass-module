...
class AssessmentTest extends UnitTestCase
{
    ...
    public function testGetInitialData()
    {
        ...
        $oCreditPass = $this->getMock(Assessment_testmod::class, array('getUser', '_checkStreetNo'));
    ...
    public function testGetUser()
    {
        ...
        $this->assertTrue($oCreditPass->getNonPublicVar('_oUser') instanceof User);
    }
    ...
    public function testDoCheckGroupExcl()
    {
        ...
        $oCrassessment = $this->getMock(Assessment_testmod::class, array('debugLog', '_checkUserGroup'));
        $oCrassessment->setNonPublicVar('_oUser', oxNew(User::class));
    ...
    public function testSetIntegratedLogicError()
    {
        ...
        $oAssessment = $this->getMock(Assessment_testmod::class, array('_getOECreditPassConfig'));
    ...
    public function testCheckUserGroup()
    {
        ...
        $oUser = $this->getMock(User::class, array('inGroup'));
        ...
        $oCrassessment = $this->getMock(Assessment_testmod::class, array('debugLog'));
    ...
    public function testGetPaymentDataHashForCreditCard()
    {
        ...
        $oCrassessment = oxNew(Assessment_testmod::class);
    ...
    public function testGetAddressIdent()
    {
        ...
        $oUser->oxuser__oxfname = new Field('testfname');
        $oUser->oxuser__oxlname = new Field('testlname');
        $oUser->oxuser__oxstreet = new Field('teststreet');
        $oUser->oxuser__oxstreetnr = new Field('teststreetnr');
    ...
    public function testGetBoniRequestXML()
    {
        ...
        $oPrice = oxNew(Price::class, 23.34);
        $oPriceList = oxNew(PriceList::class);
        $oPriceList->addToPriceList(oxNew(Price::class, 12.34));
        $oBasket = $this->getMock(Basket::class, array('getProductsPrice', 'getPrice'));
    ...
    public function testWriteDebugXML()
    {
        ...
        $oCrassessment = $this->getMock(Assessment_testmod::class, array('_getCurrentTime'));
    ...
    public function testMakeErrorXML()
    {
        ...
        $oCreditPass = $this->getMock(Assessment_testmod::class, array('_oxidGetTime'));
    ...
    {
        $oOECreditPassAssessment = $this->getMock(Assessment_testmod::class, array('_isTestMode'));
    ...
    public function testGetBoniRequestXMLWithValidIBAN()
    {
        if (class_exists('oxSepaValidator')) {
            $oOECreditPassAssessment = new Assessment_testmod();

            $sIBAN = 'DE89370400440532013000';

            $aDebitData = array('lsktonr' => $sIBAN);
            Registry::getSession()->setVariable('dynvalue', $aDebitData);

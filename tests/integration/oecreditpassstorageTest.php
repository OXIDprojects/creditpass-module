 ...
 */
class Integration_oeCreditPassStorageTest extends OxidTestCase
{
    ...
    public function testSetValue($sKey, $mValue)
    {
        ...
        $oCreditPassStorage = oeCreditPassStorage::createInstance();
    ...
    public function testGetShopId($mActualShopId, $mExpectedShopId)
    {
        ...
        $oCreditPassStorage = new oeCreditPassStorage(

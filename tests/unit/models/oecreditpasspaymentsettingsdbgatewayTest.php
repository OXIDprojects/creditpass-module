 ...
 */
class Unit_Models_oeCreditPassPaymentSettingsDbGatewayTest extends OxidTestCase
{
    ...
    {
        /** @var oeCreditPassPaymentSettingsDbGateway $oePaymentSettingsDbController */
        $oePaymentSettingsDbController = $this->getMock(
            'oeCreditPassPaymentSettingsDbGateway', array('_fetchPaymentSettingsFromDatabase')
        );
    ...
    public function testSave()
    {
        ...
        /** @var oeCreditPassPaymentSettingsDbGateway $oePaymentSettingsDbController */
        $oePaymentSettingsDbController = $this->getMock('oeCreditPassPaymentSettingsDbGateway', array('_getDb'));

 ...
 */
class unit_core_oeCreditPassStorageTest extends OxidTestCase
{
    ...
    {
        /** @var PHPUnit_Framework_MockObject_MockObject|oxConfig $oConfig */
        $oConfig = $this->getMock('oxConfig', array('getShopId'));
        $oConfig->expects($this->any())->method('getShopId')->will($this->returnValue($iShopId));

        /** @var PHPUnit_Framework_MockObject_MockObject|oeICreditPassStorageShopAwarePersistence $oShopAwarePersistence */
        $oShopAwarePersistence = $this->getMock('oeICreditPassStorageShopAwarePersistence', array('setValue', 'getValue'));
        ...
        $oStorage = new oeCreditPassStorage($oConfig, $oShopAwarePersistence);

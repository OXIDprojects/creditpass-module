...
class Unit_Controllers_Admin_oeCreditPassPaymentTest extends OxidTestCase
{
    ...
    {
        $oPaymentController = new oeCreditPass_Payment();
    ...
    public function testSave()
    {
        ...
        /** @var oeCreditPassPaymentSettingsDbGateway $oPaymentController */
        $oPaymentDbGateway = $this->getMock('oeCreditPassPaymentSettingsDbGateway', array('save'));
        $oPaymentDbGateway->expects($this->exactly(2))->method('save');

        /** @var oeCreditPass_Payment $oPaymentController */
        $oPaymentController = $this->getMock('oeCreditPass_Payment', array('_getDbGateWay'));
    ...
    public function testSavePurchaseTypeNotSet()
    {
        ...
        $oPaymentController->expects($this->once())->method('_getDbGateWay')->will(
            $this->returnValue(new oeCreditPassPaymentSettingsDbGateway())
        );
        $oPaymentController->save($aSave);
    ...
    public function testGetPaymentSettings()
    {
        ...
        /** @var oeCreditPassPaymentSettingsDbGateway $oPaymentController */
        $oPaymentDbGateway = $this->getMock('oeCreditPassPaymentSettingsDbGateway', array('loadAll'));
    ...
    public function testGetPaymentSettingsWithDefaultValues()
    {
        ...
        /** @var oeCreditPass_Payment $oPaymentController */
        $oPaymentController = $this->getMock('oeCreditPass_Payment', array('_getDbGateWay', 'getUniqueId'));
        $oPaymentController->expects($this->once())->method('_getDbGateWay')->will(
            $this->returnValue($oPaymentDbGateway)
        );
